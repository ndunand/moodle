...
$string['enablesoftlimits'] = 'Enable soft limits';
$string['enablesoftlimits_desc'] = 'If enabled here, each activity instance can choose to use soft limits. Soft limits are non-enforced limits on each choice made, and show choices made after that limit has been reached in a different color.';
$string['softlimitanswers'] = 'Enable soft limits';
$string['softlimitanswers_help'] = 'Soft limits are non-enforced limits on each choice made, and show choices made after that limit has been reached in a different color.';
$string['softlimitno'] = 'Soft limit {no}';
$string['softlimit'] = 'Soft limit';
