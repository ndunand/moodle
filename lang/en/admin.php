...
$string['configemailbulkmessaging'] = 'Should teachers be able to email participants from the course participants view?';
...
$string['emailbulkmessaging'] = 'Enable user emailing from course participants list';
