...
$string['nowebrtcsafari'] = 'Your browser offers support for WebRTC technologies as an experimental feature that you need to activate. To do so, check "Show Develop menu in menu bar" in Safari preferences\' Advanced tab, then check MediaRecorder under Experimental Features in the Develop menu. Finally, reload this page.';
$string['nowebrtcsafari_title'] = 'WebRTC not activated';
